...
const TournamentSection = () => (
    <div id="tournaments" className="grid grid-cols-1 md:grid-cols-2 gap-6 scroll-mt-48">
...
const PlayerSection = ({ onPlayerClick }) => {
    ...
    const players = getPlayersByGame('dota2');
        ...
        <div className="xl:col-span-2 space-y-6">
            ...
            <div className="bg-card border border-white/5 rounded-[2.5rem] p-8 shadow-2xl">
                {[1, 2, 3].map((i) => (
                    <div
                        key={i}
                        onClick={() => onPlayerClick(`Summoner ${i}`)}
                    ...
                    >
                        <div className="flex items-center gap-6">
                            ...
                            <div>
                                <p className="font-black uppercase tracking-tight text-xl leading-none italic group-hover:text-gold transition-colors">Summoner {i}</p>
                        ...
                        <div className="text-right">
                            ...
                            <p className="font-black text-2xl text-gold tracking-tighter italic">{750 - i * 25}</p>
                        </div>
                    </div>
                ))}
            </div>
            ...
            <div className="bg-card border border-white/10 rounded-[2.5rem] p-8 space-y-8 shadow-2xl">
                {[1, 2, 3, 4, 5].map((i) => (
                    <div key={i} className="flex flex-col gap-2">
                        <div className="flex justify-between items-center"><span className="font-black text-[10px] uppercase tracking-widest italic">{i === 1 ? 'Immortal' : i === 2 ? 'Divine' : 'Ancient'}</span><span className="font-black text-xs text-gold italic">{98 - i * i}%</span></div>
