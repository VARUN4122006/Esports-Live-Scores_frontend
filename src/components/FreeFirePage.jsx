...
const TournamentSection = () => (
    <div id="tournaments" className="grid grid-cols-1 md:grid-cols-2 gap-6 space-y-12 scroll-mt-48">
...
const PlayerSection = ({ onPlayerClick }) => {
    ...
    const players = getPlayersByGame('freefire');
        ...
        <div className="xl:col-span-2 space-y-6">
            ...
            <div className="bg-card border border-white/5 rounded-[2.5rem] p-8 shadow-2xl">
                {[1, 2, 3].map((i) => (
                    <div
                        key={i}
                        onClick={() => onPlayerClick(`Elite Player ${i}`)}
